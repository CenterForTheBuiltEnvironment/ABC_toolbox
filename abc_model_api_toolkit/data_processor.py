...
def output_json_to_csv(output_json_file_path, csv_file_path):
    ...
    for result in data['results']:
        ...
        for segment, segment_data in result['segments'].items():
            segment_data_prefixed = {f'Tskin-{segment}': segment_data['tskin'],
    ...
    column_order = [
        'elapsed_time', 'Ta', 'MRT', 'RH', 'Velocity', 'Solar', 'Clo', 'Met', 'Overall_Comfort',
        'Overall_Comfort_weighted', 'Overall_Sensation', 'Overall_Sensation_Linear', 'Overall_Sensation_Weighted',
        'MeanSkinTemp', 'Tblood', 'Tneutral', 'PMV', 'PPD', 'EHT', 'Qmet', 'Qconv', 'Qrad', 'Qsolar', 'Qresp', 'Qsweat'
    ]

    # Add segment columns to the order
    segments = ['Head', 'Chest', 'Back', 'Pelvis', 'Left Upper Arm', 'Right Upper Arm', 'Left Lower Arm',
                'Right Lower Arm', 'Left Hand', 'Right Hand', 'Left Thigh', 'Right Thigh', 'Left Lower Leg',
                'Right Lower Leg', 'Left Foot', 'Right Foot']

    for segment in segments:
        column_order.extend([
            f'Tskin-{segment}', f'Tcore-{segment}', f'Sens-{segment}', f'Sens_weighted-{segment}',
            f'Comfort-{segment}', f'Comfort_weighted-{segment}', f'EHT-{segment}', f'Tskin_set-{segment}',
