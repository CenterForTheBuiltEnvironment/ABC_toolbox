import argparse
import os
from api_client import get_abc_model_api_results
...
def main():
    ...
    parser.add_argument('--url', help="API URL", default='https://backend-384255928646.us-west1.run.app/abc')
    args = parser.parse_args()

    # Call the API and save the output JSON
    get_abc_model_api_results(args.input_file, args.output_file, args.url, args.timeout)
